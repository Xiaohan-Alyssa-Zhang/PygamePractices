...
bird_surface=pygame.image.load("image_audio/Astrun.jpg").convert_alpha()
...
#pipe surface
pipe_surface = pygame.image.load("image_audio/rocket4.png").convert()
pipe_surface=pygame.transform.scale(pipe_surface,(100,200))
pipe_list=[]
#Creat pipe by timer loop/ 1.2s 
SPAWNPIPE=pygame.USEREVENT
pygame.time.set_timer(SPAWNPIPE,800)

pipe_height=[360,300,330,250]
...
#Sound /using pygame.mixer.Sound()
flap_sound=pygame.mixer.Sound("image_audio/wing.wav")
death_sound=pygame.mixer.Sound("image_audio/die.wav")
score_sound=pygame.mixer.Sound("image_audio/point.wav")
score_withsound=100
while True: 
